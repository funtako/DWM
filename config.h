...
static const char col_win95[]       = "#A8AFB1";
static const char col_orange[]      = "#ea9f5d";


static const char *colors[][3]      = {
	/*               fg         bg         border   */
    [SchemeNorm] = { col_gray3, col_gray1, col_win95 },
    [SchemeSel]  = { col_gray4, col_cyan,  col_orange},

};

/* tagging */
static const char *tags[] = { "I", "II", "III", "IV", "V", "VI", "7", "ﱘ", "9" }; //the musical note is nf-mdi-music from nerdfonts cheat sheet
...
/*	{ MODKEY,                       XK_Tab,    view,           {0} },*/
	...
	{ MODKEY|ShiftMask,             XK_m,      setlayout,      {.v = &layouts[5]} }, /*bstack*/
